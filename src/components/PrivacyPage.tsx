      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-brand-500/10 dark:bg-brand-500/20 mb-6 shadow-sm border border-brand-500/20 dark:border-brand-500/30">
            <Shield className="w-10 h-10 text-brand-600 dark:text-accent-400" />
          </div>
        ...
        <div className="space-y-8">
          <div className="bg-slate-50 dark:bg-slate-900 rounded-[2rem] p-10 border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-xl transition-all duration-300">
            <h2 className={`text-2xl font-black text-slate-900 dark:text-white mb-6 ${isRtl ? 'font-cairo' : 'uppercase tracking-tight'}`}>1. {isRtl ? 'المعلومات التي نجمعها' : 'Information We Collect'}</h2>
            ...
            <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 space-y-3 ms-4 font-medium">
          ...
          <div className="bg-slate-50 dark:bg-slate-900 rounded-[2rem] p-10 border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-xl transition-all duration-300">
            <h2 className={`text-2xl font-black text-slate-900 dark:text-white mb-6 ${isRtl ? 'font-cairo' : 'uppercase tracking-tight'}`}>2. {isRtl ? 'كيف نستخدم معلوماتك' : 'How We Use Your Information'}</h2>
          ...
          <div className="bg-slate-50 dark:bg-slate-900 rounded-[2rem] p-10 border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-xl transition-all duration-300">
            <h2 className={`text-2xl font-black text-slate-900 dark:text-white mb-6 ${isRtl ? 'font-cairo' : 'uppercase tracking-tight'}`}>3. {isRtl ? 'أمن البيانات' : 'Data Security'}</h2>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-medium">
              {isRtl
